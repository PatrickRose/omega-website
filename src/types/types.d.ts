...
export type CreateUserFormValues = t.TypeOf<
    typeof types.CreateUserFormValuesDecode
>;
...
export type ChangePasswordFormValues = t.TypeOf<
    typeof types.ChangePasswordFormValuesDecode
>;
export type ChangePasswordSuccess = t.TypeOf<
    typeof types.ChangePasswordSuccessDecode
>;
export type ChangePasswordFailed = t.TypeOf<
    typeof types.ChangePasswordFailedDecode
>;
export type ChangePasswordResult = t.TypeOf<
...
export type EditGameFormValues = t.TypeOf<
    typeof types.EditGameFormValuesDecode
>;
