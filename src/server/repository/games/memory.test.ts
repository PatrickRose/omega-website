...
const cases: [string, Game[]][] = [["Empty repo", []]];

describe("Memory games repository - all games", () => {
    test.each(cases)("%p", async (name, expected) => {
...
const upcoming: [string, number, Game[], Game[]][] = [
    ...
    [
        "Returns all future games",
        3,
        [gameNextYear, gameTwoYear, gameThreeYear],
        [gameNextYear, gameTwoYear, gameThreeYear]
    ],
    [
        "Limits to number",
        3,
        [gameNextYear, gameTwoYear, gameThreeYear, gameFourYear],
        [gameNextYear, gameTwoYear, gameThreeYear]
    ],
    [
        "Doesn't count games in past",
        3,
        [pastGame, gameNextYear, gameTwoYear, gameThreeYear, gameFourYear],
        [gameNextYear, gameTwoYear, gameThreeYear]
    ],
    [
        "Games returned in order",
        3,
        [gameNextYear, gameThreeYear, gameTwoYear],
        [gameNextYear, gameTwoYear, gameThreeYear]
    ]
];
