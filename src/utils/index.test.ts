...
describe("dateSorter", () => {
    ...
    const cases: [string, OnlineGame[], OnlineGame[]][] = [
        ["All future", [gameFuture1, gameFuture2], [gameFuture1, gameFuture2]],
        [
            "All future (wrong order)",
            [gameFuture2, gameFuture1],
            [gameFuture1, gameFuture2]
        ],
        [
            "All future (wrong order with no date)",
            [gameFutureNoDay, gameFuture2, gameFuture1],
            [gameFutureNoDay, gameFuture1, gameFuture2]
        ],
        ["All past", [gamePast1, gamePast2], [gamePast1, gamePast2]],
        [
        ...
        [
            ...
            [gamePastNoDay, gamePast2, gamePast1],
            [gamePast1, gamePastNoDay, gamePast2]
        ],
        [
            "All games",
            [
    ...
    test.each(cases)("Sorting %p", async (name, games, expectedResult) => {
